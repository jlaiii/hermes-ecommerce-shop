...
export function CartProvider({ children }) {
  ...
  const addToCart = (product, engraving = '', engraveFont = '', engraveColor = '', engraveRotate = 0, engravePosX = 50, engravePosY = 85, engraveSize = 18) => {
    setCart((prev) => {
      ...
      return [...prev, { ...product, qty: 1, engraving, engraveFont, engraveColor, engraveRotate, engravePosX, engravePosY, engraveSize }];
    });
  };
